...
mpv --fs /home/tom/Videos/the_world_wqhd.mp4
...
DEFAULT_CACHE_FOLDER="$HOME"/Pictures # Cache folder
...
elif [ -f "/home/tom/Pictures/lock_screen.png" ]; then
    BKG_IMG="/home/tom/Pictures/lock_screen.png"  # Default image
else
...
LOCK_CMD="$($LOCK_BASE_CMD $LOCK_ARGS -n ; mpv /home/tom/Music/time_resume.mp3)"
...
# i3lock -u -i /home/tom/Pictures/lock_screen.png -n ; mpv --volume=200 /home/tom/Music/time_resume.mp3 
